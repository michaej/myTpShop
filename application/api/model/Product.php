...
class Product extends BaseModel
{
    ...
    {
        return $this->hasMany('ProductProperty', 'product_id', 'from');
    }
     ...
     * @return \think\Paginator
     */
    public static function getAllinProducts()
    {
        $query = self::all();
     ...
     * @return null | Product
     */
    public static function getThirdProductDetail($id)
    {
        //千万不能在with中加空格,否则你会崩溃的
        //        $product = self::with(['imgs' => function($query){
        //               $query->order('index','asc');
